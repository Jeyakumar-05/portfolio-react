  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center pfbg ">
        <h2 className="text-3xl font-bold mb-6 text-center navtext">
          Get in Touch
        </h2>
        <div className="w-[90%] max-w-4xl h-1/2 flex flex-col md:flex-row gap-10 justify-around items-center">
          ...
          <div className="flex flex-col items-center">
            <a
              href="https://www.linkedin.com/in/jeyakumar-s-092997274"
              target="_blank"
            >
              <Linkedin
                size={50}
          ...
          <div className="flex flex-col items-center">
            <a
              href="https://www.instagram.com/j_.e_.y_.46?igsh=MW9iaHBiY2kyMjR1MA=="
              target="_blank"
            >
              <Instagram
                size={50}
